...
class ui extends Qi {
  ...
  update(e = {}) {
    for (let n in e)
      this.attributeChangedCallback(n, null, e[n]);
  }
...
const ae = ({
  ...
  const t = {
    ...
    fontSize: typeof e == "number" ? `${e * 0.85}px` : e,
    opacity: s && !a ? 1 : 0,
